...
- AWS credentials configured locally. This is run manually from your own machine, never through CI, to avoid the chicken-and-egg problem of CI needing the roles this creates before they exist
...
Bootstrap runs once, before `infra/` is applied for the first time. Not everything it creates carries the same weight:
